...
- Secure coding practices and Linux command line
- Python for security tools and automation
- Networking and embedded systems security with Arduino

---

### 🎯 2026 Goals

- Build and document multiple cybersecurity-related projects
- Earn foundational certifications (Security+, eJPT, or equivalent)
- Contribute to open source or write technical content
- Strengthen my portfolio for internships and opportunities
